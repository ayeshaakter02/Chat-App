  ...
  <div className="bg-[#693405] rounded-2xl flex max-w-3xl p-5 items-center">
    <div className="md:w-1/2 px-8">
      ...
      <div className="mt-4 text-sm flex justify-between items-center container-mr">
        <p className="mr-3 md:mr-0 text-[#b99a8e]">If you don't have an account..</p>
        <button className=" register text-white bg-[#ac4b22]  rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#8a6455c9] font-semibold duration-300">
          Register
        </button>
      </div>
    </div>
